      ...
      "notes": [
        {
          "name": "新增",
          "descs": [
            "跟随系统壁纸设置支持中英文,且优先考虑中文关键字"
          ]
        },
        {
          "name": "说明",
          "descs": [
            "中文关键字为`暗黑`和`明亮`,英文关键字不变"
          ]
        }
      ]
    },
      ...
      "notes": [
        {
          "name": "代码编辑器",
          "descs": [
            "Surge HTTP-API 环境下执行的代码能显示响应内容"
          ]
        }
      ]
    },
